...
function About() {
    return (
        <div className='flex items-center gap-6 max-md:gap-0 mt-24 max-md:flex-col'>
            <h1 className='text-3xl font-bold text-lime-200 max-md:block hidden'>About Me</h1>
            <img src="aboutme.png" alt="" />
            <div>
                <h1 className='text-3xl font-bold text-lime-200 max-md:hidden'>About Me</h1>
